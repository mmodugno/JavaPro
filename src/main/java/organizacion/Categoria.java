...
public enum Categoria {
	...
	private Categoria(double micro,  double pequenia, double medianaTramoUno, double medianaTramoDos, int persMicro, int persPequenia, int persMedianaTramoUno, int persMedianaTramoDos) {
